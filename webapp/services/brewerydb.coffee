angular.module('clonebrews').service 'BreweryDBService', [
  '$log',
  '$q',
  '$resource',

  ($log, $q, $resource) ->
    BreweryDB = $resource '/brewery_db/search'

    # These are the no label images and will be overriden by beers that have real labels
    BreweryDB.prototype.labels =
    ...
    @search = (opts) ->
      ...
      if opts?.type is 'beer'
        opts.withBreweries ?= 'y'

      BreweryDB.query opts, (results) ->
